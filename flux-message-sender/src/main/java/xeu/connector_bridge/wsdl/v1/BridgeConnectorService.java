 ...
 * 2016-01-29T13:39:47.772+01:00
 * Generated source version: 2.7.6
 * 
 */
@WebServiceClient(name = "BridgeConnectorService", 
                  wsdlLocation = "classpath:contract/connector-bridge.wsdl",
                  targetNamespace = "urn:xeu:connector-bridge:wsdl:v1") 
public class BridgeConnectorService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("urn:xeu:connector-bridge:wsdl:v1", "BridgeConnectorService");
    public final static QName BridgeConnectorSOAP11Port = new QName("urn:xeu:connector-bridge:wsdl:v1", "BridgeConnectorSOAP11Port");
    static {
        URL url = BridgeConnectorService.class.getClassLoader().getResource("contract/connector-bridge.wsdl");
        if (url == null) {
            java.util.logging.Logger.getLogger(BridgeConnectorService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "classpath:contract/connector-bridge.wsdl");
        }       
        WSDL_LOCATION = url;   
    }
